...
:: Android packaging
set AND_CERT_NAME="TCPSocket"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TCPSocket.p12
...
set IOS_PROVISION=cert\Development.mobileprovision
...
set IOS_DIST_SIGNING_OPTIONS=-useLegacyAOT no -storetype pkcs12 -keystore "%IOS_DIST_CERT_FILE%" -provisioning-profile %IOS_PROVISION%
...
set APP_ID=jp.mztm.TCPSocket

:: Output packages
set DIST_PATH=dist
set DIST_NAME=TCPSocket
